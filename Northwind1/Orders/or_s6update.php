...
<form action="or_s6update.php">
<input name="oorid" value="">
<input name="ccid" value="">
<input name="eempid" value="">
<input name="ood" value="">
<input name="rrd" value="">
<input name="sshd" value="">
<input name="sshv" value="">
<input name="ffgh" value="">
<input name="sshn" value="">
<input name="ssha" value="">
<input name="sshc" value="">
<input name="sshr" value="">
<input name="sshpc" value="">
<input name="cchct" value="">

<input type="submit" value="or_s6update.php">
</form>

<?php
if (!isset($_GET['oorid'])) { exit; }
require("or_s1connect.php");
$sql.="update orducts set ";
$sql.="OrderID =". $_GET['oorid'] .", ";
$sql.="CustomerID ='". $_GET['ccid'] ."', ";
$sql.="EmployeeID ='". $_GET['eempid'] ."' ";
$sql.="OrderDate ='". $_GET['ood'] ."' ";
$sql.="RequiredDate ='". $_GET['rrd'] ."' ";
$sql.="ShippedDate ='". $_GET['sshd'] ."' ";
$sql.="ShippedVia ='". $_GET['sshv'] ."' ";
$sql.="Freight ='". $_GET['ffgh'] ."' ";
$sql.="ShipName ='". $_GET['sshn'] ."' ";
$sql.="ShipAddress ='". $_GET['ssha'] ."' ";
$sql.="ShipCity ='". $_GET['sshc'] ."' ";
$sql.="ShipRegion ='". $_GET['sshr'] ."' ";
$sql.="ShipPostalCode ='". $_GET['sshc'] ."' ";
$sql.="ShipCountry ='". $_GET['cchct'] ."' ";

$sql.="where OrderID =". $_GET['oorid'] ." ";
if((int)phpversion() >= 7) {
	if($connect->query($sql) === FALSE) 
		echo "$sql : failed";
	else 
		echo "<meta http-equiv='refresh' content='0; url=or_s6update.php'/>";	
	$connect->close();
} else {	
...
echo "<center><a href=or_s3select.php>back</a>";
?>
</header>
