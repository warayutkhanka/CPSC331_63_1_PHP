...
<?php
if(file_exists("emp_s1connect.php"))
...
qWork("create table $tb (EmployeeID char(4),LastName char(40),FirstName char(40),Title char(40),TitleOfCountry char(40),BirthDate char(40),HireDate char(40),Address char(40),City char(40),Region char(40),PostalCode char(40),Country char(40),HomePhone char(40),Extension char(40),Photo char(40),Notes char(40),ReportsTo char(40))");
