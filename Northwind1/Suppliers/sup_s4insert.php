...
if (!isset($_GET['supid']) || !isset($_GET['co'])) exit;
require("sup_s1connect.php");
$sql="insert into $tb values(".$_GET['supid'].",'".$_GET['co']."','".$_GET['con']."','".$_GET['cont']."','".$_GET['add']."','".$_GET['ci']."','".$_GET['re']."','".$_GET['po']."','".$_GET['cou']."','".$_GET['ph']."','".$_GET['fa']."','".$_GET['hp']."')";
if((int)phpversion() >= 7) {
