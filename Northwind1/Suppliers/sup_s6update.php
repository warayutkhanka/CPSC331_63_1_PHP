...
<input name="pub" value="">
<input name="cpn" value="">
<input name="ctn" value="">
<input name="ctt" value="">
<input name="ad" value="">
<input name="cit" value="">
<input name="reg" value="">
<input name="potc" value="">
<input name="cnt" value="">
<input name="pho" value="">
<input name="fax" value="">
<input name="hop" value="">
<input type="submit" value="sup_s6update.php">
</form>

<?php
if (!isset($_GET['pub'])) { exit; }
require("sup_s1connect.php");
$sql.="update supducts set ";
$sql.="superID =". $_GET['pub'] .", ";
$sql.="ProductID ='". $_GET['cpn'] ."', ";
$sql.="UnitPrice ='". $_GET['ctn'] ."' ";
$sql.="Quantity ='". $_GET['ctt'] ."' ";
$sql.="Discount ='". $_GET['ad'] ."' ";
$sql.="Discount ='". $_GET['cit'] ."' ";
$sql.="Discount ='". $_GET['reg'] ."' ";
$sql.="Discount ='". $_GET['potc'] ."' ";
$sql.="Discount ='". $_GET['cnt'] ."' ";
$sql.="Discount ='". $_GET['pho'] ."' ";
$sql.="Discount ='". $_GET['fax'] ."' ";
$sql.="Discount ='". $_GET['hop'] ."' ";
$sql.="where superID =". $_GET['pub'] ." ";
if((int)phpversion() >= 7) {
	if($connect->query($sql) === FALSE) 
		echo "$sql : failed";
	else 
		echo "<meta http-equiv='refresh' content='0; url=sup_s6update.php'/>";	
	$connect->close();
} else {	
...
echo "<center><a href=sup_s3select.php>back</a>";
?>
</header>
