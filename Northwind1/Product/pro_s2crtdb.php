...
qWork("create table $tb (ProductID char(4),ProductName char(40),SupplierID char(40),CategoryID char(40),QuantityPerUnit char(40),UnitPrice char(40),UnitInStock char(40),UnitsOnOrder char(40),ReorderLevel char(40),Discontinued char(40))");
