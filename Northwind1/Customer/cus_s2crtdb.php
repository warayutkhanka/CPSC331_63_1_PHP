...
<?php
if(file_exists("cus_s1connect.php"))
...
qWork("create table $tb (CustomerID char(4),CompanyName char(40),ContactName char(40),ContactTitle char(40),Address char(40),City char(40),Region char(40),PosttalCode char(40),Country char(40),Phone char(40),Fax char(40))");
